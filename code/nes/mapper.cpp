    ...
    switch (Address >> 13)
    {
        ...
        default:
        {
            ...
            switch(Address)
            {
                ...
                {
                    u8 *Rom = Cart->PrgRom + (0x2000 * (0x1F & Value));
                ...
                {
                    Cart->Rom[1] = Cart->PrgRom + (0x2000 * (0x1F & Value));
                } break;
                ...
                default:
                {
                    ...
                    if (Address & 1)
                    {
                        Cart->Mapper23.Chr[Chr] = (Cart->Mapper23.Chr[Chr] & 0xF) | ((Value & 0x1F) << 4); 
                        Cart->Chr[Chr] = Cart->ChrRom + Cart->Mapper23.Chr[Chr] * 0x400;
                    }
                    else
                    {
                        Cart->Mapper23.Chr[Chr] = (Cart->Mapper23.Chr[Chr] & 0x1F0) | (Value & 0xF);
                        Cart->Chr[Chr] = Cart->ChrRom + Cart->Mapper23.Chr[Chr] * 0x400;
                    }
                } break;
            }
